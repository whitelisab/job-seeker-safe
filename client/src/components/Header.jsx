...
function Header() {
  return (
    <Container>
      <Row className="my-3">
        <Col>
          <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 48 48" className="logo" width="75px">
            <g id="XMLID_755_">
        ...
        <Col>
          <p className="mr-2 float-right">My Account</p>
        </Col>
      </Row>
    </Container>
  );
